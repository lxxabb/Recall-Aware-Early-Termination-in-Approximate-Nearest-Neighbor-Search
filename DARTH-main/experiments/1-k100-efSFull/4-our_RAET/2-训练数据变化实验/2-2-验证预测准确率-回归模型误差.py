    ...
    for ds_name in all_datasets:
        ...
        for train_num in training_nums:
            results = train_predictors(
                ...
                M, efC, efS, d,n_estimators, columns_to_load, feature_classes, model_conf,target_recalls,train_num)

            with open(f"/root/DARTH-main-data/predictor_models/raet/{ds_name}/k{k}/训练数据量_{train_num}_的误差.json", "w") as f:
...
def train_predictors(ds_name, training_queries_num, all_k_values, all_li, M, efC, efS, d, n_estimators, columns_to_load, feature_classes, model_conf,target_recalls,train_num):
    results = {}
    # train_num=10000
    ...
    for k in all_k_values:
        ...
        for li in all_li:
            ...
            for selected_features in feature_classes:
                ...
                input_features =  ["step", "dists", "inserts","visited_points","duration","nn_dist","furthest_dist","avg_dist","variance"]
                data_all["visited_points"]=data_all["visited_points"]/k
                X_train = data_all[input_features].values

                model_file = f"/root/DARTH-main-data/predictor_models/raet/{ds_name}/k{k}/efS{efS}_s{train_num}_nestim{n_estimators}_{selected_features}_Noquery_duration.txt"
...
#     SIFT1M | k=100 | Path: /root/DARTH-main-data/data/et_training_data/raet-fea-testing/SIFT1M/k100/efS500_qs10000.txt
# 10000 Queries Data Shape: (2061731, 13) | Li: 1
# {100: {10000: {1: {'all_feats': {'mse': 0.008134555550860114, 'mae': 0.07055865200781399, 'r2': 0.8766542407110332, 'p99': 0.24282111716083024, 'p1': 0.0010344683019825052}}}}}
# Finished predict for SIFT1M
# 
#
# Starting training for GIST1M
#     GIST1M | k=100 | Path: /root/DARTH-main-data/data/et_training_data/raet-fea-testing/GIST1M/k100/efS1000_qs1000.txt
# 1000 Queries Data Shape: (251463, 13) | Li: 1
# {100: {1000: {1: {'all_feats': {'mse': 0.011225865304270275, 'mae': 0.08129865335115909, 'r2': 0.8399329038941543, 'p99': 0.29790618006280617, 'p1': 0.0011907109413332728}}}}}
# Finished predict for GIST1M
#
#
# Starting training for GLOVE100
#     GLOVE100 | k=100 | Path: /root/DARTH-main-data/data/et_training_data/raet-fea-testing/GLOVE100/k100/efS500_qs10000.txt
# 10000 Queries Data Shape: (1584146, 13) | Li: 1
# {100: {10000: {1: {'all_feats': {'mse': 0.004448784968423407, 'mae': 0.04881928487191576, 'r2': 0.9154331782668389, 'p99': 0.20585825071366184, 'p1': 0.0006761254892941493}}}}}
# Finished predict for GLOVE100
#
#
# Starting training for DEEP10M
#     DEEP10M | k=100 | Path: /root/DARTH-main-data/data/et_training_data/raet-fea-testing/DEEP10M/k100/efS750_qs10000.txt
# 10000 Queries Data Shape: (1952791, 13) | Li: 1
# {100: {10000: {1: {'all_feats': {'mse': 0.01112267052410631, 'mae': 0.08224586678024048, 'r2': 0.830957962178518, 'p99': 0.28266783641669607, 'p1': 0.0011981915026321706}}}}}
