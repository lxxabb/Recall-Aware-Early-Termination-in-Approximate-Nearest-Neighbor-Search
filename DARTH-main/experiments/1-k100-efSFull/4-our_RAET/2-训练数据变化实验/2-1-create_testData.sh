...
do
    ...
    mkdir -p ${TRAINING_DATA_DIRECTORY}/raet-fea-testing/${ds}
    ...
    for k in "${k_values[@]}"
    do
        mkdir -p ${TRAINING_DATA_DIRECTORY}/raet-fea-testing/${ds}/k${k}
        ...
        do
            ${BUILD_DIR}/hnsw-test/hnsw_test \
                    ...
                    --query-type testing \
                    --output ${TRAINING_DATA_DIRECTORY}/raet-fea-testing/${ds}/k${k}/efS${efS}_qs${query_num}.txt
        done
    done
