...
TRAIN_DATA_DIRECTORY=/home/extra_home/lxx23125236/ali/DARTH-main-data/data/et_training_data/early-stop-training/
...
do
    ...
    do
        ...
        for recall in "${recall_values[@]}"; do
          if true; then
            python /home/extra_home/lxx23125236/ali/DARTH-main/notebooks_scripts/test/Darth-获取Darth需要的distsRt.py \
                  "${TRAIN_DATA_DIRECTORY}${ds}/k${k}/efS${efSFULL}_qs${sample}_new.txt" \
                  "$recall"
          fi
        done
    done
