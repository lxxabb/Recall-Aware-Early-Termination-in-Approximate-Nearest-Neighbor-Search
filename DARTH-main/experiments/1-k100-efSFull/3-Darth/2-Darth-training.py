...
def get_dataset_name(M, efC, efS, num_queries, ds_name, k, logint):
    return f"/home/extra_home/lxx23125236/ali/DARTH-main-data/data/et_training_data/early-stop-training/{ds_name}/k{k}/efS{efS}_qs{num_queries}.txt"
...
def main():
    ...
    for ds_name in all_datasets:
        ...
        with open(f"/home/extra_home/lxx23125236/ali/DARTH-main-data/predictor_models/darth-our/{ds_name}_qs10000.json", "w") as f:
