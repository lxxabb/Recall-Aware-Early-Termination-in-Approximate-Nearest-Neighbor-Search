...
do
    read ds M efC efSFull li _<<< "$dataset_param"
    ...
    do
        ...
        mkdir -p  ${MIN_EF_PRE_QUERY_DIRECTORY}${ds}/k${k}/validation
            ...
            if true; then
              ...
              do
                  ${BUILD_DIR}/hnsw-test/hnsw_test \
                          ...
                          --output ${MIN_EF_PRE_QUERY_DIRECTORY}${ds}/k${k}/validation/min_ef_per_query_s{sample}_${target_recall}.csv \
                          --mode ${mode} \
