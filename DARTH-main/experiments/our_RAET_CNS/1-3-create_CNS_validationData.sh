...
do
    ...
    do
        ...
        for k in "${k_values[@]}"
        do
            mkdir -p ${TRAINING_DATA_DIRECTORY}/${mode}/${ds}/k${k}/validation
            ...
            do
                ${BUILD_DIR}/hnsw-test/hnsw_test \
                        ...
                        --output ${TRAINING_DATA_DIRECTORY}/${mode}/${ds}/k${k}/validation/efS${efS}_qs${query_num}.txt
            done
        done
