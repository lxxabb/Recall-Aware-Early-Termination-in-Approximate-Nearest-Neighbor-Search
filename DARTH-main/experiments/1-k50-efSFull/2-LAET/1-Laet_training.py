...
def get_dataset_name(M, efC, efS, query_num, ds_name, k, logint):
    return f"/home/extra_home/lxx23125236/ali/DARTH-main-data/data/et_training_data/early-stop-training/{ds_name}/k{k}/efS{efS}_qs{query_num}_new.txt" #_new 的意思是，有duration特征
