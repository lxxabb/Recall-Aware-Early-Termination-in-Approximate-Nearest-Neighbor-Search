...
def main():
    ...
    for ds_name in all_datasets:
        ...
        with open(f"/home/extra_home/lxx23125236/ali/DARTH-main-data/predictor_models/darth-our/k_50_{ds_name}_qs10000.json", "w") as f:
        ...
        for s in training_queries_num:
            ...
            for li in all_li:
                ...
                for selected_features in feature_classes:
                    ...
                    # 构造保存路径（和模型同名更清晰）
                    fi_file = f"/home/extra_home/lxx23125236/ali/DARTH-main-data/feature_importance/darth-our/{ds_name}/k{k}/efS{efS}_s{s}_nestim{n_estimators}_{selected_features}.csv"
                    # 保存到文件
                    ...
                    model_file = f"/home/extra_home/lxx23125236/ali/DARTH-main-data/predictor_models/darth-our/{ds_name}/k{k}/efS{efS}_s{s}_nestim{n_estimators}_{selected_features}.txt"
