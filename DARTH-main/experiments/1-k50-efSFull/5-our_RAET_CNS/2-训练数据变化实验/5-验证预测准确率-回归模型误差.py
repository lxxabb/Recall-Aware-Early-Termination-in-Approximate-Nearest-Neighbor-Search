...
def get_label_dataset_name(ds_name, k,target_recall,num_queries,efS):
    ...
    return f"/root/DARTH-main-data/data/et_training_data/raet-CNS-fea-training/{ds_name}/k{k}/test/efs{efS}_min_ef_per_query_s{num_queries}_{recall_str}.csv"
        ...
        for target_recall in target_recalls:
            ...
            for li in all_li:
                ...
                for selected_features in feature_classes:
                    ...
                    recall_str = f"{target_recall:.2f}"
                    model_file = f"/root/DARTH-main-data/predictor_models/raet-cns-regression_CNSFull/{ds_name}/k{k}/efS{efS}_s{train_num}_nestim{n_estimators}_{selected_features}_{recall_str}_CNSFull_quantile{quantile}_Noquery_Noske_Nodensty.txt"
