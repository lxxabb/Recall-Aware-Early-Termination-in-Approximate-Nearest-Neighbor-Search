...
GIST1M_tuples_k50=(
  "0.90 1000 109 323 78"
#  "0.92 1000 123 317 78"
#  "0.94 1000 150 317 78"
#  "0.96 1000 173 306 78"
#  "0.98 1000 188 270 78"
)
...
#  "0.92 1000 73 214 70"
#  "0.94 1000 90 214 70"
#  "0.96 1000 105 206 70"
#  "0.98 1000 118 184 70"
)
...
do
    ...
    do
        ...
        mkdir -p  ${RESULTS_DIRECTORY}/our/${ds}/k${k}/times/
        ...
        for tuple in "${tuples[@]}"; do
          ...
          JSON_FILE=${RESULTS_DIRECTORY}/our/${ds}/k${k}/efS${efS}_times_summary_tr${target_recall}.json
          echo "[]" > "$JSON_FILE"
            ...
            do
              out="$(
                ${BUILD_DIR}/hnsw-test/hnsw_test \
                  ...
                  --output $RESULTS_DIRECTORY/our/${ds}/k${k}/times/efS${efS}_qs${sample}_tr${target_recall}_t${time}.txt \
                  --mode ${mode} \
                  ...
                  --model-selector-path ${MODEL_DIRECTORY_SELECTOR}/${ds}/k${k}/efS${efS}_s${train_queries}_nestim${n_estim}_all_feats_recall_selector_${target_recall}.txt
              )"
#                --model-selector-path ${MODEL_DIRECTORY_SELECTOR}/query_vec_only/${ds}/k${k}/efS${efS}_qs${train_queries}_${target_recall}_query_vec_model.txt
              #--model-selector-path ${MODEL_DIRECTORY_SELECTOR}/${ds}/k${k}/efS${efS}_s${train_queries}_nestim${n_estim}_all_feats_recall_selector_${target_recall}.txt
            ...
            python /home/extra_home/lxx23125236/ali/DARTH-main/experiments/0-ALL_graphIndex_trainData/多次搜索取平均.py \
                  ${RESULTS_DIRECTORY}/our/${ds}/k${k}/times/efS${efS}_qs${sample}_tr${target_recall} \
                  ${RESULTS_DIRECTORY}/our/${ds}/k${k}/efS${efS}_qs${sample}_tr${target_recall}.txt \
                  $experiment_times

            echo "多次搜索中每个查询点的平均结果，写入完成：${RESULTS_DIRECTORY}/our/${ds}/k${k}/efS${efS}_qs${sample}_tr${target_recall}.txt"

            python /home/extra_home/lxx23125236/ali/DARTH-main/experiments/0-ALL_graphIndex_trainData/Darth-Raet-早停统计.py \
                  ${RESULTS_DIRECTORY}/our/${ds}/k${k}/efS${efS}_qs${sample}_tr${target_recall}.txt \
                  ${RESULTS_DIRECTORY}/our/${ds}/k${k}/efS${efS}_statistics_tr${target_recall}.json \
                  $target_recall

            echo "从平均搜索结果文件中，所有查询点的早停统计结果statistics，写入完成：${RESULTS_DIRECTORY}/our/${ds}/k${k}/efS${efS}_statistics_tr${target_recall}.json"
          fi
        done
    done
    echo ""
