...
datasets = ["SIFT1M", "GLOVE100", "GIST1M", "DEEP10M", "T2I1M"]
datasets = ["SIFT1M", "GIST1M",  "T2I1M"]
efs_map = {
    "SIFT1M": 500,
    "GLOVE100": 500,
    "GIST1M": 1000,
...
for dataset in datasets:
    ...
    efS = efs_map[dataset]
    # ===================== 路径 =====================
    # fea_file = f"/home/extra_home/lxx23125236/ali/DARTH-main-data/data/et_training_data/raet-CNS-fea-training/{dataset}/k{k}/efS{efS}_qs20000.txt"
    #
    # recall_label_file = f"/home/extra_home/lxx23125236/ali/DARTH-main-data/result/raet/train/{dataset}/k{k}/efS{efS}_qs20000_tr{target_recall}.txt"
    #
    # cns_label_file = f"/home/extra_home/lxx23125236/ali/DARTH-main-data/result/raet-cns-regression_CNSFull/train/{dataset}/k{k}/efS{efS}_qs20000_tr{target_recall}.txt"

    fea_file = f"/home/extra_home/lxx23125236/ali/DARTH-main-data/data/et_training_data/raet-CNS-fea-training/{dataset}/k{k}/efS{efS}_qs10000.txt"

    recall_label_file = f"/home/extra_home/lxx23125236/ali/DARTH-main-data/result/raet/train/{dataset}/k{k}/efS{efS}_qs10000_tr{target_recall}.txt"

    cns_label_file = f"/home/extra_home/lxx23125236/ali/DARTH-main-data/result/raet-cns-regression_CNSFull/train/{dataset}/k{k}/efS{efS}_qs10000_tr{target_recall}.txt"
    ...
    X = merged_final[all_features].values
    ...
    # ===================== 保存模型 =====================
    model_file = f"/home/extra_home/lxx23125236/ali/DARTH-main-data/predictor_models/our/{dataset}/k{k}/efS{efS}_s10000_nestim100_all_feats_recall_selector_{target_recall}.txt"
    ...
    fi_file = f"/home/extra_home/lxx23125236/ali/DARTH-main-data/feature_importance/our/{dataset}/k{k}/fi_{target_recall}.csv"
    ...
    X_small = merged_final[all_features].values
    ...
    # ===================== 保存规则 =====================
    rule_file = f"/home/extra_home/lxx23125236/ali/DARTH-main-data/result/our/{dataset}/k{k}/decision_tree_rules_{target_recall}.txt"
