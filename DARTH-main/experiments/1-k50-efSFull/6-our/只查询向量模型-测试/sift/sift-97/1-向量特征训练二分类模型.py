...
# 标签文件路径
recall_label_file = f"{data_dir}/result/raet/train/{ds_name}/k{k}/efS{efS}_qs{s}_tr{tr:.2f}_68.txt"
...
fi_file = f"{fi_output_dir}/efS{efS}_qs{s}_0.97_query_vec_importance.csv"
importance_df.to_csv(fi_file, index=False)
print(f"Feature importance saved to: {fi_file}")

# ================== 5. 保存模型 ==================
model_file = f"{model_output_dir}/efS{efS}_qs{s}_0.97_query_vec_model.txt"
