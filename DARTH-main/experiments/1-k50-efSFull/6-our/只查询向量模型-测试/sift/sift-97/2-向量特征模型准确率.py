...
model_file = f"{model_input_dir}/efS{efS}_qs10000_0.97_query_vec_model.txt"

# 2. 测试查询向量路径
query_vec_path = "/home/extra_home/lxx23125236/ann-data/SIFT1M/sift_query.fvecs"

# 3. 真实标签路径 (测试集)
recall_label_file = f"{data_dir}/result/raet/{ds_name}/k{k}/efS{efS}_qs{query_num}_tr{tr:.2f}_68.txt"
