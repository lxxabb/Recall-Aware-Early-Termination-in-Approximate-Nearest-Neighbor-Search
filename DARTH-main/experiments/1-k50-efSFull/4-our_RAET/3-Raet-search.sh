        ...
        for tuple in "${tuples[@]}"; do
          ...
          if true; then
            ...
            python /home/extra_home/lxx23125236/ali/DARTH-main/experiments/0-ALL_graphIndex_trainData/多次搜索取平均.py \
                  ...
                  ${RESULTS_DIRECTORY}/raet/${ds}/k${k}/efS${efS}_qs${sample}_tr${target_recall}.txt \
                  $experiment_times

            echo "多次搜索中每个查询点的平均结果，写入完成：${RESULTS_DIRECTORY}/raet/${ds}/k${k}/efS${efS}_qs${sample}_tr${target_recall}.txt"
