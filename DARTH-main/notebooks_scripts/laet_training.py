...
def get_dataset_name(M, efC, efS, query_num, ds_name, k, logint):
    return f"/home/extra_home/lxx23125236/AKNNS_experiment/DARTH-main/data/et_training_data/early-stop-training/{ds_name}/k{k}/M{M}_efC{efC}_efS{efS}_qs{query_num}_li{logint}.txt"
