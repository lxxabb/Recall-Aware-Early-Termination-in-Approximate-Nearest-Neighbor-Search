...
def get_validation_dims_df(data_df, d, ds_name, s):
    ...
    if ds_name == "SIFT1M":
        query_dims, dims_read = read_fvecs(f"/home/extra_home/lxx23125236/ann-data/sift/sift_validation_random1000.fvecs", limit=s)
    elif ds_name == "GIST1M":
...
def get_validation_dataset_name(M, efC, efS, query_num, ds_name, k, logint): 
    return f"/home/extra_home/lxx23125236/AKNNS_experiment/DARTH-main/data/et_training_data/validation_logging/{ds_name}/k{k}/M{M}_efC{efC}_efS{efS}_qs{query_num}_li{logint}_visitedPoints.txt"
