...
GIST1M_tuples_k50=(
  "0.90 1000 92 287 14"
#  "0.92 1000 104 284 16"
#  "0.94 1000 120 279 17"
#  "0.96 1000 140 268 18"
#  "0.98 1000 151 234 30"
)
...
T2I1M_tuples_k50=(
  "0.90 1000 93 242 20"
  "0.92 1000 110 254 35"
  "0.94 1000 106 234 50"
  "0.96 1000 122 225 72"
  "0.98 1000 132 202 75"
)
          ...
          for time in $(seq 1 $experiment_times); do
            ...
            output=$(
              ${BUILD_DIR}/tests/test_nsg_optimized_search \
                ...
                --model_path_classification=${MODEL_DIRECTORY}/${ds}/k${k}/efS${efS_train}_s${train_queries}_nestim${n_estimators}_all_feats_${target_recall}_quantile${quantile}_Noquery_Noske_Nodensty.txt \
