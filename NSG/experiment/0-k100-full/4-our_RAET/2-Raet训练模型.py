...
def get_dataset_name(M, efC, efS, num_queries, ds_name, k, logint):
    # return f"/home/extra_home/lxx23125236/ali/NSG-data/train_data/raet/{ds_name}/k{k}/efS{efS}_qs{num_queries}.txt"
    return f"/home/extra_home/lxx23125236/ali/NSG-data/train_data/Laet_Darth_train_data/{ds_name}/k{k}/efS{efS}_qs{num_queries}_r_ge_0.90.txt"
    # return f"/home/extra_home/lxx23125236/ali/NSG-data/train_data/Laet_Darth_train_data/{ds_name}/k{k}/efS{efS}_qs{num_queries}.txt"
...
#     if ds_name == "SIFT1M":
#         query_dims, _ = read_fvecs("/home/extra_home/lxx23125236/ali/ann-data/SIFT1M/sift_learn.fvecs", limit=s)
#     elif ds_name == "GIST1M":
#         query_dims, _ = read_fvecs("/home/extra_home/lxx23125236/ali/ann-data/GIST1M/gist_learn.fvecs", limit=s)
#     elif ds_name == "GLOVE100":
#         query_dims, _ = read_fvecs("/home/extra_home/lxx23125236/ali/ann-data/GLOVE100/learn.100K.fvecs", limit=s)
#     elif ds_name == "DEEP10M":
#         query_dims, _ = read_fvecs("/home/extra_home/lxx23125236/ali/ann-data/DEEP10M/deep10M_learn_10w_new.fvecs", limit=s)
#
        ...
        for s in training_queries_num:
            ...
            for li in all_li:
                ...
                for selected_features in feature_classes:
                    ...
                    # 构造保存路径（和模型同名更清晰）
                    fi_file = f"/home/extra_home/lxx23125236/ali/NSG-data/feature_importance/raet/{ds_name}/k{k}/efS{efS}_s{s}_nestim{n_estimators}_{selected_features}_r_ge_0.90.csv"
                    # 保存到文件
                    ...
                    model_file = (
                        f"/home/extra_home/lxx23125236/ali/NSG-data/predictor_models/raet/"
                        f"{ds_name}/k{k}/efS{efS}_s{s}_nestim{n_estimators}_{selected_features}_r_ge_0.90.txt"
                    )
...
def main():
    ...
    dataset_params = {
        ...
        "T2I1M": {"M": 80, "efC": 1000, "efS": 1000, "d": 200},
    }
    ...
    # for ds_name in [ "GIST1M", "GLOVE100", "DEEP10M"]:
    for ds_name in ["T2I1M"]:
        ...
        out_path = f"/home/extra_home/lxx23125236/ali/NSG-data/predictor_models/raet/k100_{ds_name}_qs10000.json"
