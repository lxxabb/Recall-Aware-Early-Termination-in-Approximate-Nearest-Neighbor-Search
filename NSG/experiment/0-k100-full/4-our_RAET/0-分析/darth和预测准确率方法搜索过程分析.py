...
# 文件路径
darth_file = "/root/NSG/experiment/0-k100-full/3-Darth/95test.csv"
# raet_file  = "/root/NSG/experiment/0-k100-full/4-our_RAET/95test.csv"
raet_file  = "/root/NSG/experiment/0-k100-full/4-our_RAET/95test_ge90.csv"

# 显式指定：无表头 + 列名
col_names = ["qid", "distance_counts", "r_predicted", "recall_raw"]

df_darth = pd.read_csv(darth_file, header=None, names=col_names)
df_raet  = pd.read_csv(raet_file,  header=None, names=col_names)
...
# 结果统计
print("==================首先找到，不同方法 darth 早停但 raet 未早停的数据点===========================")
...
#
darth_file = "/root/NSG/experiment/0-k100-full/3-Darth/95test_0_1.csv"
raet_file  = "/root/NSG/experiment/0-k100-full/4-our_RAET/95test_0_1.csv"
raet_file  = "/root/NSG/experiment/0-k100-full/4-our_RAET/95test_0_1.csv"
