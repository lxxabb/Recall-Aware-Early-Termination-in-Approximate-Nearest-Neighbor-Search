...
def get_dataset_name(M, efC, efS, num_queries, ds_name, k, logint):
    # return f"/root/DARTH-main-data/data/et_training_data/darth-fea-testing/{ds_name}/k{k}/efS{efS}_qs{num_queries}.txt"
...
def main():
    ...
    model_conf = {
        "darth-cns": lgb.LGBMRegressor(objective='regression', random_state=SEED, n_estimators=n_estimators, verbose = -1),
    }
    ...
    for ds_name in all_datasets:
        ...
        # with open(f"/root/DARTH-main-data/predictor_models/darth-cns-regression/{ds_name}_qs10000.json", "w") as f:
...
# 10000 Queries Data Shape: (6500321, 13) | Li: 1
# {100: {10000: {1: {'all_feats': {'mse': 0.005534379248359141, 'mae': 0.05633974447739395, 'r2': 0.939035122999071, 'p99': 0.21217375595359955, 'p1': 0.0007278114972539829}}}}}
...
# 1000 Queries Data Shape: (796942, 13) | Li: 1
# {100: {1000: {1: {'all_feats': {'mse': 0.01124547336314833, 'mae': 0.07848317647405945, 'r2': 0.8713863426437601, 'p99': 0.3133954940828966, 'p1': 0.0009657817004413432}}}}}
# Finished predict for GIST1M
#
#
# 开始进行模型预测 for GLOVE100
#     GLOVE100 | k=100 | Path: /root/NSG-data/test_data/Laet_Darth_train_data/GLOVE100/k100/efS500_qs10000.txt
# 10000 Queries Data Shape: (4514780, 13) | Li: 1
# {100: {10000: {1: {'all_feats': {'mse': 0.0030057587873481917, 'mae': 0.03787364287276936, 'r2': 0.9660800512536988, 'p99': 0.1824632305993945, 'p1': 0.00045866021146348523}}}}}
# Finished predict for GLOVE100
#
#
# 开始进行模型预测 for DEEP10M
#     DEEP10M | k=100 | Path: /root/NSG-data/test_data/Laet_Darth_train_data/DEEP10M/k100/efS750_qs10000.txt
# 10000 Queries Data Shape: (6076582, 13) | Li: 1
# {100: {10000: {1: {'all_feats': {'mse': 0.007154578015701262, 'mae': 0.06279596934376261, 'r2': 0.9187835992811908, 'p99': 0.2471874612768886, 'p1': 0.0007693301749029386}}}}}
