...
def get_dataset_name(M, efC, efS, num_queries, ds_name, k, logint):
    return f"/home/extra_home/lxx23125236/ali/NSG-data/train_data/Laet_Darth_train_data/{ds_name}/k{k}/efS{efS}_qs{num_queries}_full.txt"
...
def main():
    ...
    for ds_name in all_datasets:
        ...
        with open(f"/home/extra_home/lxx23125236/ali/NSG-data/predictor_models/darth/k100_{ds_name}_qs10000.json", "w") as f:
        ...
        for s in training_queries_num:
            ...
            for li in all_li:
                ...
                for selected_features in feature_classes:
                    ...
                    # 构造保存路径（和模型同名更清晰）
                    fi_file = f"/home/extra_home/lxx23125236/ali/NSG-data/feature_importance/darth/{ds_name}/k{k}/efS{efS}_s{s}_nestim{n_estimators}_{selected_features}.csv"
                    # 保存到文件
                    ...
                    model_file = f"/home/extra_home/lxx23125236/ali/NSG-data/predictor_models/darth/{ds_name}/k{k}/efS{efS}_s{s}_nestim{n_estimators}_{selected_features}.txt"
