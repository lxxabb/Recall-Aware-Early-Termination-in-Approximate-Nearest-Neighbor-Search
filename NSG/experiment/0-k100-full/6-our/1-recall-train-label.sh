...
RESULTS_DIRECTORY=/home/extra_home/lxx23125236/ali/NSG-data/results/raet/train
experiment_times=3
mode=our_Raet_selector_label
k_values=(100)
train_queries=20000
n_estimators=100
          ...
          for time in $(seq 1 $experiment_times); do
            ...
            output=$(
              ${BUILD_DIR}/tests/test_nsg_optimized_search \
                ...
                --model_path=${MODEL_DIRECTORY}/${ds}/k${k}/efS${efS_train}_s10000_nestim${n_estimators}_all_feats_r_ge_0.90.txt \
...
#                --model_path=/home/extra_home/lxx23125236/ali/NSG-data/predictor_models/darth/${ds}/k${k}/efS${efS_train}_s${train_queries}_nestim${n_estimators}_all_feats.txt \
          ...
          echo "选择器标签的多次搜索中每个查询点的平均结果，写入完成：${RESULTS_DIRECTORY}/${ds}/k${k}/efS${efS}_s${query_num}_tr${target_recall}.txt"
