...
def get_dataset_name(M, efC, efS, query_num, ds_name, k):
    return f"/root/NSG-data/train_data/Laet_train_data/{ds_name}/k{k}/efS{efS}_qs{query_num}.txt"
...
def main():
    ...
    for k in [100]:
        for ds_name in ["SIFT1M","GIST1M","GLOVE100","DEEP10M"]:
            ...
            print(f"[{ds_name}] 80% queries reach recall≥0.99 with dist ≤ {dist_80:.2f}")
