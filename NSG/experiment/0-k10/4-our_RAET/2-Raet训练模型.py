...
def get_dataset_name(M, efC, efS, num_queries, ds_name, k, logint):
    ...
    return f"/root/NSG-data/train_data/Laet_Darth_train_data/{ds_name}/k{k}/efS{efS}_qs{num_queries}_r_ge_0.9.txt"
            ...
            for li in all_li:
                ...
                for selected_features in feature_classes:
                    ...
                    feature_importances = pd.DataFrame({
                        "Feature": list(range(model.booster_.num_feature())),
                        "Importance": model.feature_importances_
                    })

                    fi_file = (
                        f"/root/NSG-data/feature_importance/raet/"
                        f"{ds_name}/k{k}/efS{efS}_s{s}_nestim{n_estimators}_{selected_features}_r_ge_0.9.csv"
                    )
                    ...
                    model_file = (
                        ...
                        f"{ds_name}/k{k}/efS{efS}_s{s}_nestim{n_estimators}_{selected_features}_r_ge_0.9.txt"
                    )
...
def main():
    ...
    dataset_params = {
        "SIFT1M": {"M": 32, "efC": 500, "efS": 150, "d": 128},
        "GIST1M": {"M": 32, "efC": 500, "efS": 600, "d": 960},
        # "GLOVE100": {"M": 16, "efC": 500, "efS": 500, "d": 100},
        "DEEP10M": {"M": 32, "efC": 500, "efS": 300, "d": 96},
    }
    ...
    for ds_name in ["SIFT1M", "GIST1M", "DEEP10M"]:
    # for ds_name in ["DEEP10M"]:
        ...
        out_path = f"/root/NSG-data/predictor_models/raet/{ds_name}_qs10000.json"
